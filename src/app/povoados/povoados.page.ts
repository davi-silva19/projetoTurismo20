...
public povoados: Array<any>=[];
public rabeca: Array<any>=[];
public cateaua: Array<any>=[];
public rioGrande: Array<any>=[];
public sumauma: Array<any>=[];
public engenho: Array<any>=[];
public santaMaria: Array<any>=[];
public remanso: Array<any>=[]
//Imagens
public img_rabeca: Array<any>=[];
public img_cateaua: Array<any>=[];
public img_rioGrande: Array<any>=[];
public img_sumauma: Array<any>=[];
public img_engenho: Array<any>=[];
public img_santaMaria: Array<any>=[];
public img_remanso: Array<any>=[]
